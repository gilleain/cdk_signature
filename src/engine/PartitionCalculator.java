...
public class PartitionCalculator {
     ...
     */
    public static IntegerPartition[] partition(int m, int n) {
        int[][] counts = countPartitions(m, n);
        int numberOfPartitions = counts[m][n];
        IntegerPartition[] partitions = new IntegerPartition[numberOfPartitions];
     ...
     * @return the IntegerPartition of m with n parts with rank r 
     */
    public static IntegerPartition lexicographicallyUnrank(int m, int n, int r) {
     ...
     * @return the IntegerPartition of m with n parts with rank r
     */
    public static IntegerPartition lexicographicallyUnrank(
        ...
        return new IntegerPartition(a);
    }
    
    public static void main(String[] args) {
        int m = 17;
        int n = 5;
        IntegerPartition[] partitions = PartitionCalculator.partition(m, n);
