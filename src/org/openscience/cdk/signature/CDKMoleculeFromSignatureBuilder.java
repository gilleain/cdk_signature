...
/**
 * Builds a CDK molecule from a signature.
 * 
 * @author maclean
 * @cdk.module signature
 * 
 */
public class CDKMoleculeFromSignatureBuilder extends AbstractGraphBuilder {
     ...
     */
    public CDKMoleculeFromSignatureBuilder() {
     ...
     */
    public CDKMoleculeFromSignatureBuilder(IChemObjectBuilder builder) {
